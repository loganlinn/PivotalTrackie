...
public class ProjectProvider extends ContentProvider{
	...
	private ProjectDatabase openHelper_;
	...
	public boolean onCreate() {
		...
		openHelper_ = new ProjectDatabase(context);
		return true;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
		...
		final SQLiteDatabase db = openHelper_.getReadableDatabase();
...
//		}
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		final SQLiteDatabase db = openHelper_.getWritableDatabase();
		final int match = uriMatcher_.match(uri);
